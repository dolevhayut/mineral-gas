    ...
    <div className="space-y-6 p-6 max-w-4xl mx-auto pb-24">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">פרטי תשלום עבור הלקוח</p>
          {adminSelectedCustomer && (
            <p className="text-sm text-gray-500 mt-2">
              לקוח: <strong>{adminSelectedCustomer.name}</strong> ({adminSelectedCustomer.phone})
            </p>
          )}
        </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
                  <p className="text-sm text-amber-800">
                    <strong>חשוב:</strong> אנא ציין בהעברה את מספר הטלפון של הלקוח לזיהוי התשלום
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <CardContent>
              <ol className="space-y-2 text-sm text-green-800">
                ...
                <li className="flex gap-2">
                  ...
                  <span>ודא שציינת את מספר הטלפון של הלקוח בהעברה</span>
                </li>
                <li className="flex gap-2">
                ...
                <li className="flex gap-2">
                  ...
                  <span>נאשר את התשלום ונעדכן את הלקוח על מצב ההזמנה</span>
                </li>
              </ol>
            </CardContent>
          </Card>
